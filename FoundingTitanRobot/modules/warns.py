...
import telegram
from FoundingTitanRobot import TIGERS, WOLVES, dispatcher
...
from FoundingTitanRobot.modules.sql.approve_sql import is_approved
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Eren's sticker
        keyboard = None
